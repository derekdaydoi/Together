...
export function TopBack({ title, onBack }: { title: string; onBack?: () => void }) { return <div className="top-back"><button className="icon-button" onClick={onBack} aria-label="Quay lại"><ArrowLeft size={20}/></button><strong>{title}</strong><span className="top-spacer"/></div> }
